...
| [BPTT: Vanishing & Exploding Gradients](https://mtgca.github.io/interactive-widgets/bptt_gradients_interactive.html) | AI / Deep Learning | [@mtgca](https://github.com/mtgca) | ⚠️ AI-only | Slide eigenvalue and sequence length to watch gradients amplify or vanish through time. |
...
| [Attention Q, K, V: The Library Analogy](https://mtgca.github.io/interactive-widgets/attention_qkv_library_interactive.html) | AI / Deep Learning | [@mtgca](https://github.com/mtgca) | ⚠️ AI-only | Pick a query and watch a library answer it: Keys (spine labels) are matched, matches become attention weights that add up to 100%, and the result blends the Values proportionally — a pure analogy, no equations. |
| [A Self-Attention Head, Step by Step](https://mtgca.github.io/interactive-widgets/self_attention_head_interactive.html) | AI / Deep Learning | [@mtgca](https://github.com/mtgca) | ⚠️ AI-only | Follow one attention head on a real computed example: project x into Q, K, V, take scaled dot-products, softmax into attention weights (asymmetric, non-constant diagonal), and blend the Values — then scale up to multi-head attention with dₖ = d/h. |
